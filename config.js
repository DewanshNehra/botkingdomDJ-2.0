module.exports = {
	...
	supportServer: "https://discord.gg/A2TxXTuXqC", //- Support Server Link
	Issues: "https://discord.gg/A2TxXTuXqC", //- Bug Report Link
	...
	website: "https://botkingdom.ml", //- without the / at the end
	
	nodes: [
		{
			identifier: "Main Node", //- Used for indentifier in stats commands.
			host: "152.67.3.102", //- The host name or IP of the lavalink server.
			port: 2333, // The port that lavalink is listening to. This must be a number!
			password: "ubuntuserver", //- The password of the lavalink server.
	...
	presence: {
		...
		activities: [
			{
				name: "LIFE IS BORING", //- Status Text
				type: "LISTENING", //- PLAYING, WATCHING, LISTENING, STREAMING
			},
		],
	},
	iconURL: "https://github.com/DewanshNehra/Discord-MusicBot/blob/master/assets/Music.gif", //- This icon will be in every embed's author field
};
